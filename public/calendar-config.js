...
export const reservationConfig = {
  "FHGCP_SALA_REUNIONES_A_7_👤10": {
    email: "FHGCP-A-7@uc.cl",
    location: "FHGCP-A-7@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_DECANATO_AUDITORIO_👤126": {
    email: "FHGCP-DECANATO-AUDITORIO@uc.cl",
    location: "FHGCP-DECANATO-AUDITORIO@uc.cl",
    defaultDurationMinutes: 60,
    body: "Seleccione SOLO el equipamiento que necesita para la actividad."
  },

  "FHGCP_DECANATO_SALA_CONSEJO_FACULTAD_👤25": {
    email: "FHGCP-DECANATO-SALA-CONSEJO-FACULTAD@uc.cl",
    location: "FHGCP-DECANATO-SALA-CONSEJO-FACULTAD@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_DOCTORADO_GEOGRAFIA_👤10": {
    email: "FHGCP-DOCTORADO-GEOGRAFIA@uc.cl",
    location: "FHGCP-DOCTORADO-GEOGRAFIA@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_DOCTORADO_CIENCIA_POLITICA_👤12": {
    email: "FHGCP-DOCTORADO-ICP@uc.cl",
    location: "FHGCP-DOCTORADO-ICP@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_DOCTORADO_ICP_2": {
    email: "FHGCP-DOCTORADO-ICP-2@uc.cl",
    location: "FHGCP-DOCTORADO-ICP-2@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_PASILLO_2DO_PISO_👤40": {
    email: "FHGCP-PASILLO-2DO-PISO-FACULTAD@uc.cl",
    location: "FHGCP-PASILLO-2DO-PISO-FACULTAD@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_LABORATORIO_DE_GEOMATICA_👤14": {
    email: "FHGCP-LABORATORIO-DE-GEOMATICA@uc.cl",
    location: "FHGCP-LABORATORIO-DE-GEOMATICA@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_CONSEJO_HISTORIA_👤12": {
    email: "FHGCP-SALA-CONSEJO-HISTORIA@uc.cl",
    location: "FHGCP-SALA-CONSEJO-HISTORIA@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_CONSEJO_CIENCIA_POLITICA_👤12": {
    email: "FHGCP-SALA-CONSEJO-ICP@uc.cl",
    location: "FHGCP-SALA-CONSEJO-ICP@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_CONSEJO_GEOGRAFIA_👤8": {
    email: "FHGCP-SALA-DE-CONSEJO-INSTITUTO-DE-GEOGRAFIA@uc.cl",
    location: "FHGCP-SALA-DE-CONSEJO-INSTITUTO-DE-GEOGRAFIA@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_POSTGRADO_HISTORIA_👤10": {
    email: "FHGCP-SALA-SEMINARIO-HISTORIA@uc.cl",
    location: "FHGCP-SALA-SEMINARIO-HISTORIA@uc.cl",
    defaultDurationMinutes: 60
  },

  "FHGCP_SALA_USOS_MULTIPLES_👤22": {
    email: "FHGCP-SALA-USOS-MULTIPLES@uc.cl",
    location: "FHGCP-SALA-USOS-MULTIPLES@uc.cl",
    defaultDurationMinutes: 60,
    body: "Seleccione SOLO el equipamiento que necesita para la actividad."
  },
  ...
  "FHGCP_SEMINARIO_3_👤20": {
    email: "FHGCP-SEMINARIO-3@uc.cl",
    location: "FHGCP-SEMINARIO-3@uc.cl",
    defaultDurationMinutes: 60
  },
  ...
  "FHGCP_SEMINARIO_FACULTAD_👤41": {
    email: "FHGCP-SEMINARIO-FACULTAD@uc.cl",
    location: "FHGCP-SEMINARIO-FACULTAD@uc.cl",
    defaultDurationMinutes: 60,
    body: "Seleccione SOLO el equipamiento que necesita para la actividad."
  },
  ...
  "FHGCP_TERRAZA_👤50": {
    email: "FHGCP-TERRAZA@uc.cl",
    location: "FHGCP-TERRAZA@uc.cl",
    defaultDurationMinutes: 60
  }
};